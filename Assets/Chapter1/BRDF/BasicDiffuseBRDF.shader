Shader "CookbookShaders/BasicDiffuseBRDF" {
	Properties {
	...
	SubShader {
		...
		#pragma surface surf BasicDiffuseBRDF
		...
		inline float4 LightingBasicDiffuseBRDF (SurfaceOutput s, fixed3 lightDir, half3 viewDir, fixed atten) {
